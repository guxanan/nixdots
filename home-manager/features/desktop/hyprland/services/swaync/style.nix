{
  ...
  config = lib.mkIf config.settings.desktop.hyprland.enable {
    services.swaync.style = ''
      @define-color cc-bg ${config.colors.catppuccin.mocha.rgba.crust 1.0};
      @define-color noti-border-color ${config.colors.catppuccin.mocha.rgba.surface0 1.0};
      @define-color noti-bg ${config.colors.catppuccin.mocha.rgba.base 1.0};
      @define-color noti-bg-opaque ${config.colors.catppuccin.mocha.rgba.base 1.0};
      @define-color noti-bg-darker rgb(38, 38, 38);
      @define-color noti-bg-hover ${config.colors.catppuccin.mocha.rgba.surface0 1.0};
      @define-color noti-bg-hover-opaque ${config.colors.catppuccin.mocha.rgba.surface0 1.0};
      @define-color noti-bg-focus rgba(68, 68, 68, 0.6);
      @define-color noti-close-bg rgba(255, 255, 255, 0.1);
      @define-color noti-close-bg-hover rgba(255, 255, 255, 0.15);
      @define-color text-color ${config.colors.catppuccin.mocha.rgba.text 1.0};
      @define-color text-color-disabled rgb(150, 150, 150);
      @define-color bg-selected ${config.colors.catppuccin.mocha.rgba.surface0 1.0};
      ...
      * {
      ...
      .notification-row .notification-background .notification .notification-action {
        ...
        border-top: 2px solid @noti-border-color;
        border-radius: 0px;
        border-right: 2px solid @noti-border-color;
      }
      ...
      .widget-dnd > switch:checked {
        background: ${config.colors.catppuccin.mocha.rgba.red 0.7};
      }
